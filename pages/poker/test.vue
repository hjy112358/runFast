		...
		<view class="palyS palybox " v-show='playmsgshow'>
			...
			<view class=" palybox mybox ">
				...
				<view class="cardlist clearfix cardnormal cardshowlist flex juscon-center">
					<view class="gifbox">
						<image :src="showgif?girsrc:'../../static/null.png'" mode=""></image>
					</view>
			...
			<view class="cardlist  cardnormal mycarlist flex juscon-center">
				<view class="clearfix mycardbox">
					<view class="card big cardwrap big-card" v-for='(item,index) in palySpaper' :key="index" :style="mycardleft(item,index)">
						<img :src="item.src" :cid="item.cardId" @tap='checkCard(item,index)' @touchstart="bodyTouchStart"
						 @touchmove="bodyTouchMove" @touchend="bodyTouchEnd">
						</img>
					</view>
				</view>
	...
	export default {
		data() {
			return {
				...
				palySpaper: [{
						cardvalue: "2",
						src: "../../static/image/card/15-mh.png",
						type: "mh",
						cardId: '15-mh',
						checked: false,
						card:15
					...
					{
						cardvalue: "3",
						src: "../../static/image/card/3-mh.png",
						type: "mh",
						cardId: '3-mh',
						checked: false,
						card:3
					...
					{
						cardvalue: "5",
						src: "../../static/image/card/5-mh.png",
						type: "mh",
						cardId: '5-mh',
						checked: false,
						card:5
					...
					{
						cardvalue: "7",
						src: "../../static/image/card/7-mh.png",
						type: "mh",
						cardId: '7-mh',
						checked: false,
						card:7
					...
					{
						cardvalue: "11",
						src: "../../static/image/card/11-mh.png",
						type: "mh",
						cardId: '11-mh',
						checked: false,
						card:11
				...
				showgif:false,
				girsrc:'../../static/image/gif/PLANE.gif',
			...
			showcard() {
				...
				if (checkdlist.length > 0) {
					...
					switch(result.cardKind){
						...
						case 'THREE_PAIRS':
						var myaudio=new Audio();
							myaudio.src='/static/audio/THREE_PAIRS.mp3';
							myaudio.play()
						break;
						//炸弹
						case 'BOMB':
						...
						case 'SEQUENCE':
						var myaudio=new Audio();
							myaudio.src='/static/audio/SEQUENCE.mp3';
							myaudio.play()
						break;
						// 顺子
						case 'PRIGRESSION':
